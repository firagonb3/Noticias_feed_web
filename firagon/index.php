  ...
  <body>
    ...
    <main>
      <div class="container">
        ...
        <!--Noticias-->
        <div id="div_Gral" class="row row-cols-1 row-cols-md-4">
          <?php
      ...
      <div class="botoncito-container">
        <div class="botoncito">
          <button type="button" class="btn btn-outline-danger">
            <svg xmlns="http://www.w3.org/2000/svg" width="29" height="50" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevrons-up">
